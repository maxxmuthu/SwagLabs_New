...
public class Utils extends BaseClass {
	...
	public String get_Text(WebElement element, WebDriver driver) {
        try {
            WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            wait.until(ExpectedConditions.visibilityOf(element));
            return element.getText();
        } catch (Exception e) {
            return ""; // Return empty string if there's an exception (e.g., element not found)
        }
    }
	
	//Below one is for FluentWait
